	...
	if(typeof currentSelection != "undefined"){
		...
		if(currentSelection.length == 1){
			...
			let childAttributes = await promiseGetChildAttributes;
				...
				var fenster = window.open("https://auewsv.elmcloud.de/rm/web#action=com.ibm.rdm.web.pages.showArtifactPage&artifactURI="+newArt.data.moduleUri +"&artifactInModule="+newArt.data.uri +"&componentURI="+urlComponent+"&vvc.configuration="+uriKonfiKontext, '_blank');				
