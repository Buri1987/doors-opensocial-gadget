function ableitenAnAnderenFako(){
	...
	RM.Data.Module.createArtifact(attrs, strategyAnf, function(result) {
			...
			var fenster = window.open(urlFuerSPrungZuArtefakt + modulInterneAnforderungen.uri +"&artifactInModule="+result.data.uri +"&componentURI="+modulInterneAnforderungen.componentUri+"&vvc.configuration="+uriKonfiKontext   , '_blank');
